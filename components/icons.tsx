...
export function HouseIcon({ color, size = 24 }: { color: string; size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
        d="M2.25 12 12 2.25 21.75 12M4.5 9.75v9.75a.75.75 0 0 0 .75.75h4.5v-6h4.5v6h4.5a.75.75 0 0 0 .75-.75V9.75"
        stroke={color}
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
...
// Heroicons "microphone" (outline) — the Practice tab (was a book/"Learn" glyph).
export function MicrophoneIcon({ color, size = 24 }: { color: string; size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
// Heroicons "book-open" (outline) — the Vocabulary tab.
export function BookOpenIcon({ color, size = 24 }: { color: string; size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
// Heroicons "user-circle" (outline) — the Profile tab (progress home).
export function UserCircleIcon({ color, size = 24 }: { color: string; size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
// Heroicons "pencil-square" (outline) — the edit-definition affordance.
export function PencilIcon({ color, size = 18 }: { color: string; size?: number  }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function SpeakerIcon({ color, size = 24 }: { color: string; size?: number }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
// Heroicons solid x-circle — the search clear button (recolored, visible on dark).
export function ClearIcon({ size = 18, color }: { size?: number; color: string }) {
  return (
...
// Heroicons v2 — adjustments-horizontal (sliders).
export function AdjustmentsIcon({ size = 22, color }: { size?: number; color: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
